...
public class SpringConfiguration {
		...
		public DataSource firstDataSource() {
			...
			dataSource.setUsername("spring.datasource1.username");
			dataSource.setPassword("spring.datasource1.password");
		...
		public DataSource secondDataSource() {
			...
			dataSource.setUsername("spring.datasource2.username");
			dataSource.setPassword("spring.datasource2.password");
